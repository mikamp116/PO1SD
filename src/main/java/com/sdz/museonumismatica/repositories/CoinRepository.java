...
public interface CoinRepository extends JpaRepository<Coin, Long> {
	...
	List<Coin> findAllByYear(int year);
	...
	List<Coin> findAllByAcquisition(Date date);
	...
	List<Coin> findAllByLocation(String coinLocation);
	...
	List<Coin> findAllByState(String state);
	...
	List<Coin> findAllBySupplierAndYear(Supplier supplier, int year);
	List<Coin> findAllBySupplierAndAcquisition(Supplier supplier, Date date);
	List<Coin> findAllBySupplierAndLocation(Supplier supplier, String location);
	List<Coin> findAllBySupplierAndState(Supplier supplier, String state);
}